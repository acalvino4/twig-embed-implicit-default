...
class EmbedTokenParser extends IncludeTokenParser
{
    ...
    public function parse(Token $token): Node
    {
        ...
        // inject a fake parent to make the parent() function work, and an additional tag to ensure we don't parse embed contents yet
        $stream->injectTokens([
            ...
            new Token(/* Token::BLOCK_START_TYPE */ 1, '', $token->getLine()),
            new Token(/* Token::NAME_TYPE */ 5, 'defaultblock', $token->getLine()),
        ]);
